...
export const About = () => {
  ...
  return (
    <motion.section id='about' ref={ref} className='mb-28 min-h-screen scroll-mt-28 text-center' initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
